...
public class ApplicationDTO {
    ...
    public ApplicationDTO(Date date, String firstName, String lastName, String email, String contactNumber,
                          String documentationLink, String status, Double points, Integer openingId) {
        this.date = date;
